...
public class MemberController {
        ...
        @Operation(summary = "Delete member", description = "Delete a member (ADMIN only). Cannot delete if member has active credit applications.")
        @ApiResponses({
                        @ApiResponse(responseCode = "204", description = "Member deleted successfully"),
                        @ApiResponse(responseCode = "400", description = "Cannot delete - member has active credit applications", content = @Content),
