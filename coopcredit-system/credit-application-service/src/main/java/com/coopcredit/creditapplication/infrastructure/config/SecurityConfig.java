    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Credit applications
                .requestMatchers(HttpMethod.POST, "/api/credit-applications").hasAnyRole("MEMBER", "ANALYST", "ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/credit-applications/*/evaluate").hasAnyRole("ANALYST", "ADMIN")
                .requestMatchers(HttpMethod.GET, "/api/credit-applications/**").hasAnyRole("MEMBER", "ANALYST", "ADMIN")
            ...
            .exceptionHandling(ex -> ex
                .authenticationEntryPoint((request, response, authException) -> {
                    ...
                    response.getWriter().write("{\"error\":\"Unauthorized\",\"message\":\"JWT token is required. Please login first at /api/auth/login\"}");
                })
